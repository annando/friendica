...
class Profile extends BaseModule
{
	...
	protected function post(array $request = [])
	{
		...
		if (isset($request['notify_new_posts'])) {
			$fields['notify_new_posts'] = intval($request['notify_new_posts']);
		}
	...
	protected function content(array $request = []): string
	{
		...
		$o .= Renderer::replaceMacros($tpl, [
			...
			'$notify_new_posts' => [
				'notify_new_posts',
				$this->t('Notification for new posts'),
				$localRelationship->notifyNewPosts,
				$this->t('Send a notification when this contact posts or shares something'),
				[
					LocalRelationshipEntity::NOTIFY_NEW_POSTS_NONE   => $this->t('Never'),
					LocalRelationshipEntity::NOTIFY_NEW_POSTS_ALL    => $this->t('New posts and reshares'),
					LocalRelationshipEntity::NOTIFY_NEW_POSTS_POSTS  => $this->t('New posts only'),
					LocalRelationshipEntity::NOTIFY_NEW_POSTS_SHARES => $this->t('Reshares only'),
				],
			],
